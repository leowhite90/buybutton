...
function rus_to_latin ( str ) {
	...
	if(Array.isArray(str)){
		...
		str.forEach(function(el){
			n_el = rus_to_latin(el);
			array.push(rus_to_latin(el));
		});
		return array;
	} 
        ...
        i = t(function(t, e) {
            ! function(n, i) {
                ...
                var ho, yo, mo = _t(fo),
                    ...
                    _o = '<div class="{{data.classes.product.buttonWrapper}}" data-element="product.buttonWrapper"><button {{#data.buttonDisabled}}disabled{{/data.buttonDisabled}} style="width:100%" class="{{data.classes.product.button}} {{data.buttonClass}}" data-element="product.button">{{data.buttonText}}</button></div></br><div class="{{data.classes.product.buttonWrapper}}" data-element="product.buttonWrapper"><button {{#data.buttonDisabled}}disabled{{/data.buttonDisabled}} style="width:100%" class="{{data.classes.product.button2}} {{data.buttonClass}}" data-element="product.button2">{{data.buttonText2}}</button></div>',
                    vo = {
                    ...
                    Ao = {
                        ...
                        productSet: {
                            ...
                            // order: ["title", "filter", "products", "pagination"],
							order: ["title", "products", "pagination"],
                            templates: {
                                title: '<h2 class="{{data.classes.productSet.title}}">{{data.collection.attrs.title}}</h2>',
								// filter: '<div>filter</div>',
                                products: '<div class="{{data.classes.productSet.products}} filter-container"></div>',
                                pagination: '<button class="{{data.classes.productSet.paginationButton}} {{data.nextButtonClass}}">{{data.text.nextPageButton}}</button>'
                            },
                            classes: {
                                wrapper: "shopify-buy__collection-wrapper",
                                productSet: "shopify-buy__collection cd-gallery",
                        ...
                        cart: {
                            ...
                            text: {
                                ...
                                total: "ИТОГО",
                                currency: "грн",
                                notice: "Купон на скидку можно ввести на этапе оформления",
                                noteDescription: "Комментарий к заказу"
                            }
                        },
                        lineItem: {
                            templates: Co,
                ...
                var Vo = {
                    ...
                    Ko = function() {
                        ...
                        return t.prototype.load = function() {
							...
							/*
							this.scriptTag3 = this.document.createElement('script');
							this.scriptTag3.async = 'true';
							this.scriptTag3.src = "libs/jquery/jquery-1.11.2.min.js";
							this.document.head.appendChild(this.scriptTag3);
							
							this.scriptTag2 = this.document.createElement('script');
							this.scriptTag2.src = "js/jquery.mixitup.min.js";
							this.document.head.appendChild(this.scriptTag2);
							
							this.scriptTag1 = this.document.createElement('script');
							this.scriptTag1.src = "js/iframe_script.js";
							this.document.head.appendChild(this.scriptTag1);
							
							this.styleTag2 = this.document.createElement('link');
							this.styleTag2.rel = "stylesheet";
							this.styleTag2.href = "/css/iframe_style.css";
							this.document.head.appendChild(this.styleTag2);
							
							
							this.divTag = this.document.createElement('div');
							this.divTag.className = "filters";
							this.divTag.innerHTML = jQuery.ajax({type: "GET", url: "filter-controllers.html", async: false}).responseText;
							this.document.body.appendChild(this.divTag);*/
                        }, Ro(t, [{
                            key: "width",
                            get: function() {
                ...
                var Yo = function() {
                    ...
                    ca = function(t) {
                        ...
                        return ne(e, t), e.prototype.resizeOnLoad = function() {
							...
							var params_eng = new Array();
							var filters = new Array();
							this.component.model.options.forEach(function(element) {
								params = Object.values(element.values);
								params_eng.length = 0;
								params.forEach(function(el, index){
									params_eng.push(rus_to_latin(String(el)));
									
								});
								if (typeof array_val[element.name] == 'undefined') {
									array_val[element.name] = params;
								}
								if (typeof array_keys[rus_to_latin(element.name)] == 'undefined') {
									array_keys[rus_to_latin(element.name)] = params_eng;
								} 							  
								if (typeof array_keys[rus_to_latin(element.name)] != 'undefined') {
									array_keys[rus_to_latin(element.name)] = array_keys[rus_to_latin(element.name)].concat(params_eng);
									array_keys[rus_to_latin(element.name)] = [...new Set(params_eng)];
								}
								if (typeof array_val[element.name] != 'undefined') {
									array_val[element.name] = array_val[element.name].concat(params);
									array_val[element.name] = [...new Set(params)];
								}
								filters = filters.concat(params_eng);
								
								// filters = 
								// console.log(array_keys(filters));
															  
							});
							// console.log(filters);
                            return this.component.isButton ? '<div class="mix ' + this.wrapperClass + " " + this.component.classes.product.product + ' '+ filters.join(' ') + '"><div tabindex="0" role="button" aria-label="' + e + '" class="' + this.component.classes.product.blockButton + '">' + t + "</div></div>" : '<div class="mix ' + this.wrapperClass + " " + this.component.classes.product.product + ' '+ filters.join(' ') + '">' + t + "</div>"
                        }, sa(e, [{
                            key: "className",
                            get: function() {
                    ...
                    ya = function(t) {
                        ...
                        return ue(e, t), e.prototype.stopPropagation = function(t) {
                        ...
                        }, e.prototype.onButtonClick2 = function(t, e) {
                            var n = this;
                            t.stopPropagation(), function() {
								parent.postMessage({							
									price: n.selectedVariant.price,
									title: n.model.title+" "+n.selectedVariant.title,
									id: n.model.id,
									source: '1click'
								}, "*");
                            }()
                            ...
                            t.keyCode === fa && this.onButtonClick2(t, e)
                            ...
                            key: "buttonText2",
                            get: function() {
                                return "modal" === this.options.buttonDestination ? this.options.text.button2 : this.variantExists ? this.variantInStock ? this.options.text.button2 : this.options.text.outOfStock : this.options.text.unavailable
                            }
                        }, {
                            key: "buttonEnabled",
                            get: function() {
                            ...
                            get: function() {
                                ...
                                }, de(t, "click " + this.selectors.option.select, this.stopPropagation.bind(this)), de(t, "focus " + this.selectors.option.select, this.stopPropagation.bind(this)), de(t, "click " + this.selectors.option.wrapper, this.stopPropagation.bind(this)), de(t, "click " + this.selectors.product.quantityInput, this.stopPropagation.bind(this)), de(t, "click " + this.selectors.product.quantityButton, this.stopPropagation.bind(this)), de(t, "change " + this.selectors.option.select, this.onOptionSelect.bind(this)), de(t, "click " + this.selectors.product.button, this.onButtonClick.bind(this)), de(t, "click " + this.selectors.product.button2, this.onButtonClick2.bind(this)),de(t, "click " + this.selectors.product.blockButton, this.onButtonClick.bind(this)), de(t, "keyup " + this.selectors.product.blockButton, this.onBlockButtonKeyup.bind(this)), de(t, "click " + this.selectors.product.quantityIncrement, this.onQuantityIncrement.bind(this, 1)), de(t, "click " + this.selectors.product.quantityDecrement, this.onQuantityIncrement.bind(this, -1)), de(t, "blur " + this.selectors.product.quantityInput, this.onQuantityBlur.bind(this)), de(t, "click " + this.selectors.product.carouselItem, this.onCarouselItemClick.bind(this)), de(t, "click " + this.selectors.product.carouselNext, this.onCarouselChange.bind(this, 1)), de(t, "click " + this.selectors.product.carouselPrevious, this.onCarouselChange.bind(this, -1)), t), this.options.DOMEvents)
                            }
                        }, {
                            key: "optionsHtml",
                            get: function() {
                    ...
                    $a = function() {
                        ...
                        return t.prototype.createComponent = function(t, e) {
                            ...
                            return i.iframe && this._bindEsc(i.iframe.el.contentWindow || i.iframe.el), this.components[t].push(i), i.init().then(function() {
								// var data = jQuery.ajax({type: "GET", url: "filter-controllers.html", async: false}).responseText;
